...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-dew-dd53
```

A live public deployment of this template is available at [https://shrill-dew-dd53.templates.workers.dev](https://shrill-dew-dd53.templates.workers.dev)
